    ...
    <div class="container-page pt-10 lg:pt-16 pb-12 ">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start lg:items-stretch">
        ...
        <div class="lg:col-span-7 xl:col-span-6 flex flex-col gap-7 lg:gap-8">
          ...
          <div>
            <span class="badge-pill">
              ...
              <span> Safety, Quality & Transparency in Every Session</span>
            </span>
          </div>

          <!-- Headline -->
          <h1 id="hero-heading"
            class="heading-display text-balance text-[2rem] sm:text-4xl lg:text-[3rem] xl:text-[3.4rem] leading-[1.06] "
            style="line-height: 100%;" v-motion :initial="{ opacity: 0, y: 24 }"
            :enter="{ opacity: 1, y: 0, transition: { duration: 700, delay: 200, ease: [0.22, 1, 0.36, 1] } }">
            Learn from
            <span class="text-gradient-brand"> Background </span>
          ...
          <div class="sm:col-span-2 w-full  items-center justify-between px-4 py-3">
            ...
            <div class="text-sm leading-tight">
              ...
              <p class="text-slate-700">
                ...
                <span class="font-semibold text-slate-900">14k+</span> students
              </p>
            </div>
          </div>
        ...
        <div class="relative flex min-h-0 lg:col-span-5 xl:col-span-6 lg:self-stretch">
          <HeroVisual class="w-full" image-src="/img/hero/hero3.png" />
        </div>
      </div>
      <!-- Trust Indicators -->
